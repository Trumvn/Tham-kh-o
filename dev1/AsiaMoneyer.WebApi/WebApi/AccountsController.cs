...
namespace AsiaMoneyer.WebApi.Controllers
{
    ...
    public class AccountsController : BaseApiController
    {
        ...
        Client.ISubscriptionAppService _subscriptAppService;

        public AccountsController(Client.IClientAppService clientAppService, Client.ISubscriptionAppService subscriptAppService)
        {
            this._clientAppService = clientAppService;
            this._subscriptAppService = subscriptAppService;
        }
        ...
        public async Task<IHttpActionResult> CreateUser(CreateUserBindingModel createUserModel)
        {
            ...
            try
            {
                ...
                this._subscriptAppService.CreateStartSubscriptionForNewUser(user.Id);
        ...
        public async Task<IHttpActionResult> UpdateCurrentUserProfile(ClientDto clientDto)
        {
            ...
            if (user != null && clientDto != null)
            {
                try
                {
                    ...
                    this._clientAppService.UpdateUserProfile(clientDto);
