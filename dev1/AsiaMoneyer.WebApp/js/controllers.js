...
angular
    ...
    .controller('ProjectTransferMoneyCtrl', ProjectTransferMoneyCtrl)
    ...
    .controller('AccountContentCtrl', AccountContentCtrl)
    .controller('AccountYourAccountCtrl', AccountYourAccountCtrl)
    .controller('AccountUpgradeCtrl', AccountUpgradeCtrl)
    .controller('AccountPaymentMethodCtrl', AccountPaymentMethodCtrl)
