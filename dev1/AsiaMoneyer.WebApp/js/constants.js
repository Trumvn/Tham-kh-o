...
var Constants = (function () {
    ...
    // local
    var rootApiUrl = '/webapi/api';
    var authenticationService = '/webapi/oauth/';

    // dev
    //var rootApiUrl = 'http://dev.aegona.com/api';
    //var authenticationService = 'http://dev.aegona.com/oauth/';
    ...
    var WebApi = {
        ...
        Project: {
            ...
            GetProjectRecentActivity: rootApiUrl + '/projects/getProjectRecentActivity',
            ...
            GetProjectCategories: rootApiUrl + '/projects/getProjectCategories',
            ...
            SetProjectArchived: rootApiUrl + '/projects/setProjectArchived',
            SetProjectFavorite: rootApiUrl + '/projects/setProjectFavorite',
            ...
            GetParentCategories: rootApiUrl + '/projects/getParentCategories',
            CheckParent: rootApiUrl + '/projects/CheckParent',
            TransferMoney: rootApiUrl + '/projects/transferMoney',
            GetFavoriteProjectHeaders: rootApiUrl + '/projects/getFavoriteProjectHeaders',
        },
        Client: {
            ...
            GetUserCurrentSubscription: rootApiUrl + '/clients/getUserCurrentSubscription',
            GetUserUpgradeProducts: rootApiUrl + '/clients/getUserUpgradeProducts',
        },
        Faq: {
        ...
        Billing: {
            PlaceOrder: rootApiUrl + '/billing/placeOrder',
            Purchase: rootApiUrl + '/billing/purchase',
            PaymentSuccess: rootApiUrl + '/billing/paymentSuccess',
            GetPaymentMethods: rootApiUrl + '/billing/getPaymentMethods',
            GetInvoiceProductPrices: rootApiUrl + '/billing/getInvoiceProductPrices',
            PayInvoice: rootApiUrl + '/billing/payInvoice',
        },
    };
    ...
    var Events = {
        ...
        ProjectHighlightColorChanged: 'ProjectHighlightColorChanged',
        ProjectFavoriteChanged: 'ProjectFavoriteChanged',
        ProjectNewProjectAdded: 'ProjectNewProjectAdded',
        ProjectAddingNew: 'ProjectAddingNew'
    };
